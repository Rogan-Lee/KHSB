...
// 운영 Supabase project-ref 의 SHA-256 (공개 저장소라 원문 대신 해시 — scripts/db-push.mjs 와 같은 값)
...
const isProd = createHash("sha256").update(projectRef.toLowerCase()).digest("hex") === PROD_PROJECT_REF_SHA256;
